...
function Card({
  ...
  return (
    <div
      ...
      data-size={size}
      className={cn(
        "card group/card gap-(--card-spacing) overflow-hidden bg-card py-(--card-spacing) text-sm text-card-foreground border border-border [--card-spacing:--spacing(6)] has-[>img:first-child]:pt-0 data-[size=sm]:[--card-spacing:--spacing(4)] *:[img:first-child]:rounded-none *:[img:last-child]:rounded-none",
        className
      )}
      {...props}
    />
